export const UI = {
  ...
  pages: {
    home: {
      ...
      guestCardTitle: "Я гость",
      guestCardDescription: "Выберите интересующее событие и подходящий слот — забронировать встречу можно в несколько кликов.",
      ownerCardTitle: "Я владелец",
      ownerCardDescription: "Управляйте событиями, настраивайте доступное время и держите под контролем все запланированные встречи.",
    },
    catalog: {
