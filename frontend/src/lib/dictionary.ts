export const UI = {
  ...
  pages: {
    home: {
      ...
      guestCardTitle: "Войти как гость",
      guestCardDescription: "Просмотрите доступные события и забронируйте удобное время для встречи в пару кликов.",
      ownerCardTitle: "Войти как владелец",
      ownerCardDescription: "Управляйте типами событий, настраивайте доступность и просматривайте предстоящие встречи.",
    },
    catalog: {
