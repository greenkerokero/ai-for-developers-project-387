export const UI = {
  ...
  pages: {
    home: {
      ...
      guestCardDescription: "Найдите подходящее событие и выберите удобное время — бронирование займёт всего пару кликов.",
      ownerCardTitle: "Я владелец",
      ownerCardDescription: "Создавайте события, задавайте расписание доступности и следите за списком предстоящих встреч.",
    },
    catalog: {
